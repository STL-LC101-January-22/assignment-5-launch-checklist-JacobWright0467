...
describe ("GRADING DOM MANIPULATION TEST: ", function () {
   ...
   it ("Mission target has the appropriate info", function() {
     ...
     expect(testTarget).toEqual('<h2>MissionDestination</h2><ol><li>Name:Saturn/Titan</li><li>Diameter:5149.5km</li><li>Star:Sol</li><li>DistancefromEarth:1.4billionkmfromEarth</li><li>NumberofMoons:0</li></ol><imgsrc="https://solarsystem.nasa.gov/system/resources/detail_files/16278_PIA20016.jpg"><!--Fetchsomeplanetarydata-->');
   })
